...
const Challenges = () => {
  ...
  return (
    <div className="min-h-full w-full max-w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden rounded-2xl">
        ...
        >
          {loading ? (
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="font-semibold">Generate New Challenges</span>
            </div>
          )}
        </button>
              ...
              <div className="bg-slate-900/30 p-4 rounded-lg mb-4 border border-slate-700/30">
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <span className="text-xs font-semibold text-blue-400 uppercase tracking-wide">Recommended Book</span>
        ...
        {completedChallenges.length > 0 && (
          <div className="border-t border-slate-700/50 pt-8">
            <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-slate-100">
              ...
              Completed Challenges
              <span className="bg-emerald-500/20 text-emerald-300 text-sm px-3 py-1 rounded-full border border-emerald-500/30">
